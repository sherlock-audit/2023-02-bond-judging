...
# SWC-101 Arithmetic Overflow and Underflow on parameter params.baseDiscount and params.maxDiscountFromCurrent.  BondFixedExpiryOSDAV1.t.sol BondFixedExpiryOSDA.sol function testCorrectness_CannotCreateMarketWithInvalidParams() params.baseDiscount and params.maxDiscountFromCurrent

SWC-101 Arithmetic Overflow and Underflow on parameter params.baseDiscount and params.maxDiscountFromCurrent.  BondFixedExpiryOSDAV1.t.sol BondFixedExpiryOSDA.sol function testCorrectness_CannotCreateMarketWithInvalidParams() params.baseDiscount and params.maxDiscountFromCurrent

## Summary
The Set max discount from current lower and try to set base discount greater should revert.  But it does not revert when using integer overflow for max discount and underflow for base discount.  1 call to test the Set max discount from current lower and try to set base discount greater using overflow and underflow does not revert.  The result is market created with several payout tokens.

## Vulnerability Detail
```solidity
// In the function
// function testCorrectness_CannotCreateMarketWithInvalidParams() 
// the following line was suffixed with integer overflow and underflow.  
// Set max discount from current lower and try to set base discount greater
        params.maxDiscountFromCurrent = uint48(20e3) + uint48(1) ; // fate32 ovf
        params.baseDiscount = uint48(20e3 + 1) - uint48(1); // fate32 unf
        vm.expectRevert(err);
...
```solidity
// Set max discount from current lower and try to set base discount greater
        params.maxDiscountFromCurrent = uint48(20e3) + uint48(1) ; //fate32 you are here need to submit
        params.baseDiscount = uint48(20e3 + 1) - uint48(1); // fate32 and here need to submit
        vm.expectRevert(err);
        auctioneer.createMarket(abi.encode(params));
```
...
[PASS] testCorrectness_BondTokenMetadata(uint8,uint8,bool,int8,int8,uint8) (runs: 256, μ: 1039, ~: 1028)
[PASS] testCorrectness_BondTokenMustBeCreatedByTeller(uint8,uint8,bool,int8,int8,uint8) (runs: 256, μ: 1038, ~: 1026)
[PASS] testCorrectness_BondTokenRedemption(uint8,uint8,bool,int8,int8,uint8) (runs: 256, μ: 1013, ~: 1004)
[PASS] testCorrectness_BondTokensIssued(uint8,uint8,bool,int8,int8,uint8) (runs: 256, μ: 1035, ~: 1028)
[FAIL. Reason: Call did not revert as expected] testCorrectness_CannotCreateMarketWithInvalidParams() (gas: 5212262)
Traces:
  [5201062] BondFixedExpiryOSDAV1Test::testCorrectness_CannotCreateMarketWithInvalidParams() 
    ...
    ├─ [0] VM::expectRevert(Auctioneer_InvalidParams()) 
    │   └─ ← ()
    ├─ [365160] BondFixedExpiryOSDA::createMarket() 
    │   ├─ [68254] BondAggregator::registerMarket(MockERC20: [0xA4AD4f68d0b91CFD19687c881e50f3A00242828c], MockERC20: [0x03A6a84cD762D9707A21605b548aaaB891562aAb]) 
    │   │   └─ ← 5
    │   ├─ [249] MockERC20::decimals() [staticcall]
    │   │   └─ ← 18
...
[PASS] testCorrectness_PayoutFor(uint8,uint8,bool,int8,int8,uint8) (runs: 256, μ: 1014, ~: 1005)
...
[PASS] testCorrectness_baseDiscount(uint8,uint8,bool,int8,int8,uint8) (runs: 256, μ: 994, ~: 984)
...
[PASS] testCorrectness_isLive(uint48) (runs: 256, μ: 514, ~: 491)
...
[PASS] testCorrectness_maxAmountAccepted(uint8,uint8,bool,int8,int8,uint8) (runs: 256, μ: 1015, ~: 1006)
...
[PASS] testFail_CreateMarketParamOutOfBounds(uint8,uint8,bool,int8,int8,uint8) (runs: 256, μ: 63968, ~: 29909)
...
[PASS] test_createMarket_anyAddress(address) (runs: 256, μ: 3125842, ~: 3125920)
Test result: FAILED. 41 passed; 1 failed; finished in 210.41ms
